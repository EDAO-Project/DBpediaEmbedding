...
COPY ./rdf2vec/src/main/resources/environment.yml ./src/main/resources/environment.yml
...
COPY ./rdf2vec/pom.xml ./pom.xml
RUN mvn dependency:go-offline -B
COPY ./rdf2vec/src ./src
...
ENTRYPOINT ["conda", "run", "--no-capture-output", "-n", "jrdf2vec_env", "java", "-Xmx500g", "-jar", "/app/jrdf2vec.jar"]
